                        ...
                        <x-dropdown>
                            ...
                            <x-slot name="content">
                                ...
                                <form method="POST" action="{{ route('chirps.destroy', $chirp) }}">
                                    @csrf
                                    @method('delete')
                                    <x-dropdown-link :href="route('chirps.destroy', $chirp)" onclick="if (confirm('Are you sure to dalate this chirp?')) { event.preventDefault(); this.closest('form').submit(); } else { return false}">
                                        {{ __('Delete') }}
                                    </x-dropdown-link>
                                </form>
                            </x-slot>
